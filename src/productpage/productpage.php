...
<body class="" >
    ...
    <div class="shadow border border-secondary-subtle border-2 bg-white container">
        <div class=" center-div shadow row row-cols-1 row-cols-md-3">
            <div class="my-6 col  g-4" style="width: 50%;" >
                <img src="<?php echo htmlspecialchars($product['image_url']); ?>" class="img-fluid" style="width: 100%;" alt="Product Image">
            </div>
        ...
        <form action="delateproduct.php" method="post">
            ...
            <form id="productForm" method="post" >
                <div class="col-md-6">
                    ...
                    <span class="old-price text-muted">MAD<?php echo $product['prix']-($product['prix']*$product['discount']); ?></span>
    ...
    <input name="quantity" type="number" class="border border-3 rounded-4 " style="width: 40px; text-align: center;" value="1" id="quantityInput">
    <span class="input-group-btn">
