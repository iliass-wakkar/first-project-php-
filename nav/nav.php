...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="position: fixed; top: 0; width: 100%; z-index: 1000;" >
  <div class="container-fluid">
    <a class="navbar-brand" href="../homepage/homepage.php">php projet</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../homepage/homepage.php">Accueil</a>
        </li>
        <?php 
    if(isset($_SESSION['client'])){
        ...
        <li><a class="dropdown-item" href="../login/let.php">singout</a></li>
      </ul></li>';
      ...
      echo "<li class='nav-item'>
          <a class='nav-link' href='../gestionadmin/gestion.php'>Gestion Clients</a>
        </li>";
        ...
        echo '<li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="../login/login.php">S\'identifier</a></li>
                  <li><a class="dropdown-item" href="../inscrire/inscrirepage.php">Inscription</a></li>
                </ul>
              </li>';
    }
?>
        ...
        <form method="post" action="../verifiersearch/verifiersearch.php" class="px-4 d-flex" role="search">
      ...
      </ul><?php require_once('../functions/functions.php');
      $cart=new cart;
...
<span class='small'>".$count."</span></span></i></a>";
        ...
        echo "<a href='../card/cart.php'><i class='px-3 fa-solid fa-cart-shopping'><span class='badge bg-danger rounded-circle'>
