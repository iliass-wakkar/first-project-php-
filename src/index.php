...
<body>
  ...
  <div class="cover-title shadow img_bg ">
    ...
    <button type="button" class="cover-title shadow cost_btn btn btn-lg btn-warning position-absolute   mt-3 ml-3"><a
        class="text-decoration-none text-reset" href="#product-list">Acheter maintenant</a></button>
    <a class="text-decoration-none" href="#product-list"> <i class="cost_icon fa-solid fa-5x fa-sort-down"
  ...
  <div class="shadow row ">
    <div class="prod_div col  position-relative shadow border border-secondary-subtle border-2 bg-white">
      <div class="d-flex justify-content-center align-items-center position-absolute start-0 container row"
        style="width:350px">
        <span class="col-4">sort by:</span>
        <div class="row col mx-1">
          <div class="position-relative  border border-2 py-1 rounded-start-4 col">
            <a class=" text-decoration-none text-reset d-flex justify-content-center align-items-center"
              href="sortPrix.php">
          ...
          <div
            class="position-relative col d-flex justify-content-center align-items-center border border-2 py-1 rounded-end-4 ">
            <a class=" text-decoration-none text-reset d-flex justify-content-center align-items-center"
              href="sortDate.php">
